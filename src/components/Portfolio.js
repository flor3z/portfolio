      ...
      >
        ...
        <div className="flex justify-center col-span-full">
          <div
            ...
            className={`${
              inView
                ? 'dark:bg-gray-600 text-center shadow-xl p-10 rounded-xl my-5 max-md:w-full w-1/2 justify-center animate-jump-in animate-once animate-duration-1000 animate-delay-[1200ms] animate-ease-in-out'
                : ''
            }`}
          >
            <img
            ...
            <p className="dark:text-slate-300 py-2 mb-2">
              ...
              favourite pokémon using this simple to use search engine. Spell
              the name and get the stats along with a fun image.
            </p>
            <a
              className="rounded-full bg-blue-500 hover:bg-blue-700 text-white p-2 dark:bg-slate-900  dark:hover:bg-slate-700"
              target="blank_"
