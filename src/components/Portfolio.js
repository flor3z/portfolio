...
function Portfolio() {
  return (
    <div>
      <div className="dark:text-white flex justify-center text-4xl my-8 font-sans font-medium items-center">
        Personal Projects
      </div>
      <div className="grid md:grid-cols-2 gap-10 p-10 max-w-6xl mx-auto">
        <div className="dark:bg-gray-600  flex-1 text-center shadow-2xl p-10 rounded-xl my-5 mx-auto">
          <img
            alt="portrait"
        ...
        <div className="dark:bg-gray-600  flex-1 text-center shadow-lg p-10 rounded-xl my-5 mx-auto">
          <img
            alt="portrait"
            className=" mx-auto rounded-xl"
            src={score}
        ...
        <div className="dark:bg-gray-600  flex-1 text-center shadow-lg p-10 rounded-xl my-5 mx-auto">
          ...
          <p className="dark:text-slate-300 py-2 mb-2">
            Are you forgetting to complete daily tasks? Well keep track of
            chores, update and complete them with this simple app!
          </p>
          <a
            className="rounded-full bg-blue-600 text-white p-2 dark:bg-slate-800"
            target="blank_"
        ...
        <div className="dark:bg-gray-600 flex-1 text-center shadow-lg p-10 rounded-xl my-5">
          <img
            alt="portrait"
            className=" mx-auto rounded-xl"
            src={pokemon}
