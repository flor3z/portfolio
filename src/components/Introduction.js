    ...
    <div className="flex-col items-center sm:max-w-4xl mx-auto">
      <div className="flex mx-auto gap-24 max-sm:flex-wrap max-sm:mt-4 p-4 mt-10">
        ...
        <div className="flex-col">
          <h2 className="text-6xl mb-2 font-semibold">Hello there!</h2>
          <div className="text-2xl font-thin py-2">
      ...
      <div className=" my-10 flex justify-between max-sm:flex-wrap p-4">
        <div className="flex-col">
          <h2 className="text-6xl my-2 front-semibold">My Journey Until Now</h2>
          <p className="text-xl font-thin py-2">
            Looking to always break through new boundires, I have leveraged
            different resources such as Udemey & YouTube to aid in the
            development of my programatic understanding. With this newfound
        ...
        <div className="flex h-fit flex-wrap p-2 mt-4">
          <div className="border rounded-lg border-gray-800 m-2 p-2">
            JAVASCRIPT
          </div>
          <div className="border rounded-lg border-gray-800 m-2 p-2">REACT</div>
          <div className="border rounded-lg border-gray-800 m-2 p-2">
            HTML/CSS
          </div>
          <div className="border rounded-lg border-gray-800 m-2 p-2">GIT</div>
          <div className="border rounded-lg border-gray-800 m-2 p-2">
            VERSION CONTROL
          </div>
          <div className="border rounded-lg border-gray-800 m-2 p-2">
          ...
          <div className="border rounded-lg border-gray-800 m-2 p-2">SASS</div>
          <div className="border rounded-lg border-gray-800 m-2 p-2">NPM</div>
          <div className="border rounded-lg border-gray-800 m-2 p-2">
            BOOTSTRAP
          </div>
        </div>
